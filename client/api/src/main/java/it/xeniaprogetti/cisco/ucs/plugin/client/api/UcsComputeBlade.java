...
public final class UcsComputeBlade extends UcsEntity {
    ...
    public final String scaledMode;
    ...
    public static UcsComputeBlade.Builder builder() {
        return new UcsComputeBlade.Builder();
    }
    ...
    private UcsComputeBlade(Builder builder) {
        ...
        this.scaledMode = builder.scaledMode;
    ...
    public static class Builder {
        ...
        public Builder withChassisId(int chassisId) {
        ...
        public Builder withScaledMode(String scaledMode) {
        ...
        public Builder withVid(String vid) {
            this.vid = vid;
            return this;
        }

        public UcsComputeBlade build() {
            return new UcsComputeBlade(this);
        }
    }
}