...
public class UcsEtherRxStats extends UcsEtherResourceTypeStats {
    ...
    private UcsEtherRxStats(Builder builder) {
        super(builder.dn, UcsEnums.ClassId.etherRxStats, UcsEnums.ClassItem.statsItem, builder.intervals, builder.suspect, builder.thresholded, builder.timeCollected, builder.update);
    ...
    public static class Builder {
        ...
        public UcsEtherRxStats build() {
            return new UcsEtherRxStats(this);
        }
    }
}
